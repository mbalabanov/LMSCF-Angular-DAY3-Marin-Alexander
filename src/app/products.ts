...
export const products = [
	{
 		name: 'Dog Food',
		price: 4.99,
		photo: 'assets/img/dog-food.jpg',
		description: 'This is beed wet food. Science Diet Canine Senior was developed to meet the nutrient and energy needs of mature adult dogs 7+ years of age.'
	},
 	{
		name: 'Cat Food',
		price: 3.99,
	...
	},
	{
		name: 'Fish Food',
		price: 1.99,
		photo: 'assets/img/fish-food.jpg',
		description: 'TetraFin Goldfish Flakes features a New and improved formula for cleaner and clearer water- guaranteed . This scientifically developed mix of highly nutritious ingredients plus vitamins, minerals and trace elements is easily digested.'
	}
];